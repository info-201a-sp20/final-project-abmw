...
## Summary Information
In 2019,`country_prod` countries and republics exported/imported coffee. During the year, `bean_import` bags (each weighing 60kg) of beans were imported globally.
