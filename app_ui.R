...
intro_page <- tabPanel(
  ...
  img("The Stages of Coffee", src = "https://images.unsplash.com/photo-1511920170033-f8396924c348?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"),
  h2("Overview"),
